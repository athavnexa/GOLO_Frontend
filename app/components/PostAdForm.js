          ...
          <div className="post-ad-category-details space-y-5 rounded-2xl border border-gray-200 bg-white p-4 shadow-md sm:space-y-6 sm:rounded-3xl sm:p-8">
            ...
            {selectedCategory.name === "Matrimonial" && (
              <div className="grid grid-cols-2 gap-6">
                ...
                <div><label className="text-sm font-medium text-gray-700">Age</label><input type="number" min="0" onKeyDown={(e) => { if (e.key === '-') e.preventDefault(); }} placeholder="28" className={inputStyle} value={matrimonialAge} onChange={e => setMatrimonialAge(e.target.value)} /></div>
            ...
            {selectedCategory.name === "Vehicle" && selectedSub === "Sell" && (
              <div className="grid grid-cols-2 gap-6">
                ...
                <div><label className="text-sm font-medium text-gray-700">Year</label><input type="number" min="0" onKeyDown={(e) => { if (e.key === '-') e.preventDefault(); }} placeholder="2020" className={inputStyle} value={vehicleSellYear} onChange={(e) => setVehicleSellYear(e.target.value)} /></div>
                <div><label className="text-sm font-medium text-gray-700">KM Driven</label><input type="number" min="0" onKeyDown={(e) => { if (e.key === '-') e.preventDefault(); }} placeholder="15000" className={inputStyle} value={vehicleSellKMDriven} onChange={(e) => setVehicleSellKMDriven(e.target.value)} /></div>
                ...
                <div><label className="text-sm font-medium text-gray-700">Price</label><input type="number" min="0" onKeyDown={(e) => { if (e.key === '-') e.preventDefault(); }} placeholder="500000" className={inputStyle} value={vehicleSellPrice} onChange={(e) => setVehicleSellPrice(e.target.value)} /></div>
              </div>
            )}
            ...
            {selectedCategory.name === "Vehicle" && selectedSub === "Rent" && (
              <div className="grid grid-cols-2 gap-6">
                ...
                <div><label className="text-sm font-medium text-gray-700">Per Day Rent Amount</label><input type="number" min="0" onKeyDown={(e) => { if (e.key === '-') e.preventDefault(); }} placeholder="1000" className={inputStyle} value={vehicleRentAmount} onChange={(e) => setVehicleRentAmount(e.target.value)} /></div>
                <div><label className="text-sm font-medium text-gray-700">Security Deposit</label><input type="number" min="0" onKeyDown={(e) => { if (e.key === '-') e.preventDefault(); }} placeholder="5000" className={inputStyle} value={vehicleRentDeposit} onChange={(e) => setVehicleRentDeposit(e.target.value)} /></div>
