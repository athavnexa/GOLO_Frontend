      ...
      >
        ...
        <div className="flex items-start justify-between px-4 py-3 sm:px-5 sm:py-4 border-b border-gray-200">
          <div className="flex items-start gap-2">
            ...
            <div>
              <h2 className="text-base font-bold text-gray-800 leading-tight sm:text-lg">Report This User</h2>
              <p className="text-[11px] text-gray-500 mt-0.5 sm:text-xs">Help us review suspicious or inappropriate users.</p>
            </div>
          </div>
          <button
            onClick={handleClose}
        ...
        <div className="px-3 py-3 sm:px-4 sm:py-4">
          {submitted ? (
            <div className="text-center py-4 sm:py-6">
              ...
              <p className="text-xs text-gray-600 sm:text-sm">Thank you for helping keep GOLO safe. Our team will review this user shortly.</p>
            </div>
          ) : (
            <>
              {userName && (
                <div className="mb-3 px-3 py-2 sm:mb-4 sm:px-3.5 sm:py-3 bg-gray-50 rounded-lg border border-gray-200">
                  <p className="text-[10px] text-gray-500 mb-0.5 uppercase tracking-wide sm:text-xs sm:mb-1.5">Reporting user</p>
                  <p className="text-xs font-semibold text-gray-800 truncate leading-snug sm:text-sm">{userName}</p>
                </div>
              )}
